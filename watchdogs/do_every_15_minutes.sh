...
then
    ...
    echo "MONETDBD_TK process is not running anymore" >> /home/numascale/scripts/date.txt
...
then
    ...
    echo "MONETDBD_VJ process is not running anymore" >> /home/numascale/scripts/date.txt
...
then
    echo $MOSQUITTO_VJ >> /home/numascale/scripts/date.txt 
else 
    echo "The MQTT msg collection with Mosquitto is not running for VEJLE" >> /home/numascale/scripts/date.txt
...
then
    echo $MOSQUITTO_TK >> /home/numascale/scripts/date.txt 
else 
    echo "The MQTT msg collection with Mosquitto is not running for TRONDHEIM" >> /home/numascale/scripts/date.txt
    screen -S mosquitto_VEJLE -d -m /home/climathon09/ctt_data_collection_TRONDHEIM/collectSensorDataCTT.py
